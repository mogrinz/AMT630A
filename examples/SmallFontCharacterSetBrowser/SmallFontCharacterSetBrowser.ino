...
static const uint16_t SCAN_MIN = 0x1C0;
static const uint16_t SCAN_MAX = 0x3FF;
static const uint8_t PAGE_COLS = 16;
static const uint8_t PAGE_ROWS = 7;
static const uint16_t PAGE_COUNT = PAGE_COLS * PAGE_ROWS;
static const uint16_t CELL_W = 10;
static const uint16_t CELL_H = 16;
static const uint8_t WINDOW_COLS = 31;
static const uint8_t WINDOW_ROWS = 13;
...
void printHelp() {
  Serial.println();
  Serial.println("AMT630A SmallFont Character Set Browser");
...
void setup() {
  ...
  if (!display.setDisplayOrigin(0, 57, 25)) { printError("setDisplayOrigin"); return; }
